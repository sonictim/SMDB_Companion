...
export const defaultHotKeys: HashMap[] = [
  ...
  {"settings": "CmdOrCtrl+,"},
  {"showDatabaseSearchWindow": "CmdOrCtrl+S"},
  {"showFileSystemSearchWindow": "CmdOrCtrl+F"},
  {"showMmetadataFindReplaceWindow": "CmdOrCtrl+D"},
  {"toggleSearchBar": "S"},
  {"toggleNoFrills": "N"},
  {"showToolbars": ","},
  {"showAdvancedSearchView": "Shift+CmdOrCtrl+S"},
  {"showResultsView": "2"},
  {"showSplitView": "3"},
  {"showNoFrillsView": "4"},
  {"showRegistration": "5"},
