import {
  ...
  slot,
  validate_each_keys
} from "./chunk-66ZIO4CG.js";
import {
  append,
  template,
  text
} from "./chunk-VUL4QHLW.js";
import {
  FILENAME,
  HMR,
  child,
  ...
  template_effect,
  tick
} from "./chunk-Q366ZBYL.js";
import "./chunk-MEESTFRS.js";
import "./chunk-GSEQNHTF.js";
import "./chunk-X4YQYBGL.js";
import "./chunk-3VM3XH4O.js";
...
function VirtualList($$anchor, $$props) {
  ...
  let height_map = [];
  let rows;
  let viewport = mutable_state();
  let contents = mutable_state();
  let viewport_height = mutable_state(0);
  let visible = mutable_state();
  let mounted = mutable_state();
  let top = mutable_state(0);
  let bottom = mutable_state(0);
  let average_height;
  ...
  template_effect(() => set_custom_element_data(svelte_virtual_list_viewport, "style", `height: ${height() ?? ""};`));
  ...
  template_effect(() => set_custom_element_data(svelte_virtual_list_contents, "style", `padding-top: ${get(top) ?? ""}px; padding-bottom: ${get(bottom) ?? ""}px;`));
